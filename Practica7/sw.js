    ...
    const respCache = caches.open(STATIC_CACHE_NAME).then((cache) =>{
        return cache.addAll(
            [
                ...
                'https://img.buzzfeed.com/buzzfeed-static/static/2014-10/24/18/enhanced/webdr08/enhanced-13719-1414190267-25.jpg?downsize=700%3A%2A&output-quality=auto&output-format=auto'
            ]
        );
    });
